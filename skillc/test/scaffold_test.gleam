...
pub fn init_skill_yaml_content_test() {
  let dir = "/tmp/skillc-test-init-content"
  let _ = simplifile.delete(dir)
...
pub fn init_instructions_content_test() {
  let dir = "/tmp/skillc-test-init-instructions"
  let _ = simplifile.delete(dir)
...
pub fn init_prevents_overwrite_test() {
  let dir = "/tmp/skillc-test-init-overwrite"
  let _ = simplifile.delete(dir)
...
pub fn init_compilable_test() {
  ...
  let dir = "/tmp/skillc-test-init-compilable"
  let _ = simplifile.delete(dir)
