...
pub fn import_openclaw_fixture_test() {
  let output_dir = "/tmp/skill_universe-test-import-oc"
...
pub fn import_claude_code_fixture_test() {
  let output_dir = "/tmp/skill_universe-test-import-cc"
  let _ = simplifile.delete(output_dir)
...
pub fn import_codex_fixture_test() {
  let output_dir = "/tmp/skill_universe-test-import-cdx"
  let _ = simplifile.delete(output_dir)
...
pub fn roundtrip_openclaw_test() {
  let compile_dir = "/tmp/skill_universe-roundtrip-compile-oc"
  let import_dir = "/tmp/skill_universe-roundtrip-import-oc"
...
pub fn roundtrip_claude_code_test() {
  let compile_dir = "/tmp/skill_universe-roundtrip-compile-cc"
  let import_dir = "/tmp/skill_universe-roundtrip-import-cc"
  let _ = simplifile.delete(compile_dir)
  let _ = simplifile.delete(import_dir)
...
pub fn roundtrip_codex_test() {
  let compile_dir = "/tmp/skill_universe-roundtrip-compile-cdx"
  let import_dir = "/tmp/skill_universe-roundtrip-import-cdx"
  let _ = simplifile.delete(compile_dir)
  let _ = simplifile.delete(import_dir)
...
pub fn import_no_skill_md_fails_test() {
  let dir = "/tmp/skill_universe-test-no-skill-md"
...
pub fn import_invalid_frontmatter_fails_test() {
  let dir = "/tmp/skill_universe-test-invalid-fm"
  let _ = simplifile.delete(dir)
  let _ = simplifile.create_directory_all(dir)
...
pub fn import_output_dir_already_has_skill_yaml_fails_test() {
  let output_dir = "/tmp/skill_universe-test-existing-skill"
  let _ = simplifile.delete(output_dir)
...
pub fn import_with_provider_hint_test() {
  let output_dir = "/tmp/skill_universe-test-import-hint"
  let _ = simplifile.delete(output_dir)
...
pub fn import_missing_name_field_fails_test() {
  let dir = "/tmp/skill_universe-test-missing-name-field"
  let _ = simplifile.delete(dir)
  let _ = simplifile.create_directory_all(dir)
  let _ =
    simplifile.write(
...
pub fn import_invalid_version_fails_test() {
  let dir = "/tmp/skill_universe-test-invalid-version"
  let _ = simplifile.delete(dir)
  let _ = simplifile.create_directory_all(dir)
  let _ =
    simplifile.write(
